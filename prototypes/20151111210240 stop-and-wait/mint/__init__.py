...
def before_worker_output(f):
    network.network.before_worker_output = f

def after_worker_output(f):
    network.network.after_worker_output = f

def before_worker_input(f):
    network.network.before_worker_input = f

def after_worker_input(f):
    network.network.after_worker_input = f
