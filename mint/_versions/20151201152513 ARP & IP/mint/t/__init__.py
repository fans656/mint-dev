...
from mint import network, exceptions, PDU
...
def gen(n, cls, *args, **kwargs):
    return tuple(cls(*args, **kwargs) for _ in xrange(n))
...
from mint.devices import Host, Hub, Switch
